	...
	<style type="text/css">
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                var body = $("body");
                <%
                if((int)session.getAttribute("questionerLoginFailed") == 1){
                    %>
                ...
                else if((int)session.getAttribute("questionerBlocked") == 1){
                    %>
                ...
                else if((int)session.getAttribute("questionerForgotPassword") == 1){
                    %>
