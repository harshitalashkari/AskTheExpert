        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $(box).append('<div class="mainContent"><div class="userIcon"><i class="fa fa-user-circle-o"></i></div>'+
                    '<p class="name"><% out.print(session.getAttribute("questionerFirstName") + " " + session.getAttribute("questionerLastName")); %></p>'+
                    '<p class="email"><% out.print(session.getAttribute("questionerMailID")); %> </p><br>'+
